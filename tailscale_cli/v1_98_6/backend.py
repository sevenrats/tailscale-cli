...
Source : https://github.com/tailscale/tailscale/blob/7e87f0d39bc454bcac41f01ffa87911bdac332ad/ipn/backend.go
...
class Notify(SerdeMixin):
    ...
    peer_changes: List[Optional[Dict[str, Any]]] = field(default_factory=list)  # json="PeerChanges"
