...
Source : https://github.com/tailscale/tailscale/blob/87ab41993e0aba0965ef887af38c2543572bef3a/ipn/prefs.go
...
class Prefs(SerdeMixin):
    ...
    allow_single_hosts: marshalAsTrueInJSON = None  # json="AllowSingleHosts"
    ...
    __json_map__: ClassVar[Dict[str, str]] = {
        ...
        "AllowSingleHosts": "allow_single_hosts",
...
@dataclass
class marshalAsTrueInJSON(SerdeMixin):
    pass
