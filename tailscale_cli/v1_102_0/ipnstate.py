...
Source : https://github.com/tailscale/tailscale/blob/35283c95445fb198af1ce708dac05714bdfaa037/ipn/ipnstate/ipnstate.go
Commit : 35283c95445fb198af1ce708dac05714bdfaa037
Generated: 2026-09-12T10:09:27Z
"""
...
class Status(SerdeMixin):
    ...
    extra_records: List[Dict[str, Any]] = field(default_factory=list)  # json="ExtraRecords"
...
# key authority.
@dataclass
class TailnetLockStatus(SerdeMixin):
...
@dataclass
class TailnetLockUpdate(SerdeMixin):
...
class PeerStatus(SerdeMixin):
    id: StableNodeID = StableNodeID("")  # json="ID"
    node_id: NodeID = NodeID(0)  # json="NodeID"
