...
Source : https://github.com/tailscale/tailscale/blob/28f6c2dbfc5d3f7dde8d566a9214f6e0f55a9d17/ipn/backend.go
...
class EngineStatus(SerdeMixin):
    ...
    live_der_ps: int = 0  # json="LiveDERPs"; number of active DERP connections
