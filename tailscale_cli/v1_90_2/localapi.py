...
Source : https://github.com/tailscale/tailscale/blob/8bcd44ecf07ba1ba8134526b6ed39b9e9e880b7b/ipn/localapi/localapi.go
Commit : 8bcd44ecf07ba1ba8134526b6ed39b9e9e880b7b
Generated: 2026-05-26T00:53:51Z
"""
...
ENDPOINTS = [
    ...
    {"route": "check-reverse-path-filtering", "methods": ["GET"], "permission": "read", "params": []},
    {"route": "upload-client-metrics", "methods": ["POST"], "permission": "none", "params": []},
    {"route": "update/check", "methods": ["GET"], "permission": "none", "params": []},
    {"route": "suggest-exit-node", "methods": ["GET"], "permission": "none", "params": []},
...
class LocalAPI(LocalAPIBase):
    ...
    def check_reverse_path_filtering(self, timeout: float = 30.0) -> Dict[str, Any]:
        """Check reverse-path filtering status.

        GET /localapi/v0/check-reverse-path-filtering
        Requires ``read`` permission.
        """
        resp = self._request("GET", "check-reverse-path-filtering", timeout=timeout)
        return resp.json()
    ...
    def suggest_exit_node(self, timeout: float = 30.0) -> Dict[str, Any]:
        """Suggest an exit node based on current conditions.

        GET /localapi/v0/suggest-exit-node
        """
        resp = self._request("GET", "suggest-exit-node", timeout=timeout)
        return resp.json()
